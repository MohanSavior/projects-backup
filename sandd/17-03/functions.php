...
<div class="watchlists-tags-main-sec">
	<ul>
		<li><label for="watchlists-post-tag"><input type="checkbox" name="" id=""> Saas </label></li>
		<li><label for="watchlists-post-tag"><input type="checkbox" name="" id=""> Tech </label></li>
		<li><label for="watchlists-post-tag"><input type="checkbox" name="" id=""> Tag </label></li>

		<li><label for="watchlists-post-other"><input type="checkbox" name="" id="watchlists-post-other"> Other </label></li>

		<li><input type="text" name="" id="watchlists-post-other"></li>
	</ul>
