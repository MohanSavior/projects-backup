...
<div class="welcom-page">
	<div class="container">
		...
		<div class="main-head text-center">
			<h1><span>Welcome to the Ultimate Surfskate Selector</span></h1>
	...
	<form id="msform">
		...
		<div class="surfskate-models surfskating-filtering">
			<div class="container">
				...
				<!-- .Filter Buttons Starts Here -->
				<div class="surfskating-filters-btns-box filtering-actions">
					<!-- <button type="button" class="btn surfskating-filter-btn filtering-action" data-filtering="swelltech">
<figure class="figure">
<img src="<?=site_url('wp-content/uploads/2022/04/mod-cat-01.png')?>" alt="SwellTech">
</figure>
<p>SwellTech</p>
</button> -->
					<?php 
