...
<div class="woocommerce_account_subscriptions">
	...
	<thead>
		<tr>
			...
			<th class="subscription-next-payment order-date woocommerce-orders-table__header woocommerce-orders-table__header-order-date woocommerce-orders-table__header-subscription-next-payment"><span class="nobr"><?php echo esc_html_x( 'Next payment 1', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
			<?php 
			/*
