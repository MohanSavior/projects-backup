...
jQuery(document).on('gform_post_render', function (event, form_id, current_page) {
	if (form_id == 3) {
		jQuery('#input_3_1_3').attr("value", savior_ajax_obj.current.first_name);
		jQuery('#input_3_1_6').attr("value", savior_ajax_obj.current.last_name);
		jQuery('#input_3_3').attr("value", savior_ajax_obj.current.phone_number);
		jQuery('#input_3_7').attr("value", savior_ajax_obj.current.organization);
	}
});
/**
