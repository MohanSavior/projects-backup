			...
			<div class="offer-post-single">
				...
				<table class="subs-user-list-cls">
					<thead>
						...
						<th>Offer Name</th>
						<?php 
							printf('<th>%s #%s</th>',get_the_title( $business_profile_post_id ), get_the_ID()); 
						?>
						<tr>
					</thead>
					<tbody>
						<tr>
							...
							<?php setlocale(LC_MONETARY,NULL);
								printf('<td>$ %s</td>', number_format(get_post_meta( get_the_ID(), 'offer_value', true ),2,".",",")); 
							?>
						</tr>
						<tr>
							<th>Sent Date</th>
...
add_shortcode( 'test', function(){
	...
	$posts = get_posts($args);
		...
		print_r($posts);echo"<br>";
		// print_r(get_post_meta(2174));echo"<br>";
