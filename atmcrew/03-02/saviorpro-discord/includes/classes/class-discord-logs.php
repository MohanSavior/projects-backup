 ...
 */
class SaviorPro_Discord_Logs {
	function __construct() {
		// Clear all existing logs.
		add_action( 'wp_ajax_atm_saviorpro_discord_clear_logs', array( $this, 'atm_saviorpro_discord_clear_logs' ) );
	}
	 ...
	 * @return None
	 */
	public function atm_saviorpro_discord_clear_logs() {
