(function (global) {
    ...
    function cloneNode(node, filter, root) {
        ...
        function makeNodeCopy(node) {
            if (node instanceof HTMLCanvasElement) return util.makeImage(node.toDataURL('image/jpeg', 1.0));
    ...
    function newUtil() {
        ...
        function toBlob(canvas) {
            return new Promise(function (resolve) {
                var binaryString = window.atob(canvas.toDataURL('image/jpeg', 1.0).split(',')[1]);
