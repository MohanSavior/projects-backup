...
/**
 * Recurly Connect base REST controller class.
 */
abstract class WC_Recurly_Connect_REST_Controller extends WP_REST_Controller {
	 ...
	 * Constructor.
	 *
	 * @param WC_Recurly_Connect_API $api recurly connect api.
	 */
	public function __construct( WC_Recurly_Connect_API $api ) {

		$this->api = $api;
	}

	/**
	 * Registers rest routes for recurly connect functionality
	 */
